...
%	p.KeepUnmatched = true;
	...
	kernel_hypothesis = @(inputs, theta) nadarayaWatsonEstimator(krFeature(inputs, data.inputs.train),...
																 data.targets.train,...
																 kernelFunction,...
																 theta,...
																 p.Results.kernelscaling);

	theta = train(data.inputs.validate, data.targets.validate, kernel_hypothesis, 0, theta0, p.Results.options);
